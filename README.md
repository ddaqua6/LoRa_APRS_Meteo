...
<h2>Meteostation Apple Shortcut for your iPhone/Apple Watch</h2><br>
...
/ - meteo dashboard with WebSocket (the values update automatically) - WebSocket uses port 5028<br>
